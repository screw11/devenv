...
"if gvim display conflict with video card, use below or disable 3D accel
"set ttyscroll=0
...
" convenient with the same key as ctrl+6(^) in mini keyboard
map <F6> :e #<CR>
...
map <F9> :TrinityToggleNERDTree<CR>
